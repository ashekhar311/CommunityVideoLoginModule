  ...
  render() {
    ...
    return (
      <div>
        ...
        <h2 className="mt-4 text-center bg-danger text-white">Let's Get Ready to Join the Room</h2>

        <img src="videocall.jpg" className="design"></img>

        <button  className="room">{localUname} Join Room</button>
